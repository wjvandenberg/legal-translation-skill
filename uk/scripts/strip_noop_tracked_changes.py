...
def _strip_empty_wrappers(paragraph):
    ...
    **B3 — AN INSERTION WRAPPER IS NEVER STRIPPED WHILE IT STILL CARRIES TEXT,
    ...
    them, so survival came down to how many runs the neighbouring text happened
    to occupy. The condition below needs no window and no neighbour — the
    ...
    for element in list(paragraph):
        ...
        # is on what survives normalisation rather than on the tag alone.
