...
| **`evidence/REGISTER-findings.md`** | the evidence base — **228 rows**, every finding with its per-document proof. **The fastest way to understand what the project has learned** | whenever you need the proof behind any claim | every finding, clustered by root cause |
...
**Context: 51% — read by Wouter at the close and not estimated**, the twenty-fifth recorded reading. **Recorded, never obeyed:** this session ended because its planned work ran out.
