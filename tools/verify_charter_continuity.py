...
LEDGER = [
    ("the tree totals",            "3,651,835",                    ["evidence/EVIDENCE-a3-structure.md"]),
    ("a per-file byte figure",     "57,269",                       ["evidence/EVIDENCE-a3-structure.md"]),
    ("the truncation position",    "55,466",                       ["evidence/EVIDENCE-a3-structure.md"]),
    ("L1's unpairable entries",    "46 of 1,158",                  ["evidence/REGISTER-findings.md"]),
    ("G9's segment keys",          "412 of 412",                   ["evidence/REGISTER-findings.md"]),
    ("C9's detector rate",         "2 times in 13",                ["evidence/REGISTER-findings.md"]),
    ("G12's residue",              "16 `quality_check` FINDINGS",  ["evidence/REGISTER-findings.md"]),
    ("I-17's closure",             "I-17",                         ["evidence/REGISTER-findings.md"]),
    ("I-18's recurrence",          "I-18",                         ["evidence/REGISTER-findings.md"]),
    ("I-19's baseline pin",        "I-19",                         ["evidence/REGISTER-findings.md"]),
    ("I-20's fixture rebuild",     "I-20",                         ["evidence/REGISTER-findings.md"]),
