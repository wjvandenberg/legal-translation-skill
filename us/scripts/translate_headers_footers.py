...
only known boilerplate (watermarks, standardized role labels).
...
MODE 3 — Legacy dictionary lookup (fallback):
    ...
    watermarks and standardized role labels. Prints a one-line notice
...
# standardized boilerplate (watermarks, role labels). They are NOT a
